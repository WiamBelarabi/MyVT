...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_FILES['file'])) {
    ...
    foreach ($salles as $salle => $etudiants) {
        ...
        $html ='<h3 style="text-align:center; font-size:14px; ">CP1</h3>
        <p style="text-align:center;font-size:12px;">Liste des étudiants - Salle ' . htmlspecialchars($salle) . '</p>
        <h4 style="text-align:center;font-size:12px;">Filière : Cycle Préparatoire - Sciences et Techniques pour l\'ingénieur <br> Première année (STPI1)</h4>';
...
<body>
    <div class="container">
    <div class="header">
        <h1>Génération des listes CP1</h1>
        <p>Importez un fichier Excel pour générer automatiquement les documents pour la liste CP1</p>
    </div>

    <form action="listecp1.php" method="post" enctype="multipart/form-data" id="upload-form" target="_blank">
        <div class="upload-section" id="drop-area">
            <i class="fas fa-file-excel file-icon"></i>
            <p>Glissez-déposez votre fichier Excel ici ou cliquez pour sélectionner un fichier contenant les données des CP1</p>
