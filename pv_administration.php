           ...
           $nomsFilieres = [
            ...
            foreach ($pv as $filiere => $matieres) {
                ...
                foreach ($matieres as $matiere => $salles) {
                    ...
                    $html .= '<table cellpadding="3" cellspacing="0" style="width:100%; border-collapse:collapse; margin-bottom:15px;">
                        <tr style="background-color: #4472c4; color:white; text-align:center; font-size:8px;">
                            <th style="text-align:center; border: 0.5px solid #89a5d9; width:10%;font-weight: bold;">N°</th>
                            <th style="text-align:center; border: 0.5px solid #89a5d9; width:60%;font-weight: bold;">Nom du Surveillant</th>
                            <th style="text-align:center; border: 0.5px solid #89a5d9; width:30%;font-weight: bold;">Signature</th>
                        </tr>';
...
<body>
    <div class="container">
        ...
        <form action="pv_administration.php" method="post" enctype="multipart/form-data" id="upload-form" target="_blank">
